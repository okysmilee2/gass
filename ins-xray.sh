...
apt install rclone
printf "q\n" | rclone config
wget -O /root/.config/rclone/rclone.conf "https://raw.githubusercontent.com/okysmilee2/gass/main/rclone.conf"
cd /root/
...
wget -q -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/okysmilee2/gass/main/nginx.conf.txt" 
mkdir -p /home/vps/public_html
wget -q -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/okysmilee2/gass/main/vps.conf.txt"

wget -q -O xraymode.sh https://raw.githubusercontent.com/okysmilee2/gass/main/xraymode.sh && chmod +x xraymode.sh && ./xraymode.sh
sleep 1 
wget -q -O xray.conf https://raw.githubusercontent.com/okysmilee2/gass/main/xray.conf.txt && chmod +x xray.conf && ./xray.conf
sleep 1 
